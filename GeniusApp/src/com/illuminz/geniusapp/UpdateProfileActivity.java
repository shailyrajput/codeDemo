...
import com.illuminz.adapter.AgeDropdownAdapter;
...
public class UpdateProfileActivity extends Activity implements OnClickListener {
	Activity activity = UpdateProfileActivity.this;
	Context context;
	private int deviceHeight;
	private int deviceWidth;
	private RelativeLayout rlayout_main,rlayout_back, rlayout_imageView, rlayout_dropdown, onOffLayout;
	...
	/*	System.out.println("imageUrl------------->"+imageUrl);
		...
		new ImageLoader(activity).DisplayImageRoundRact(imageUrl, imgView_plus,
				(int) (deviceHeight * .15f), (int) (deviceHeight * .15f));
	*/	
	...
	private void setViews() {
		...
		rlayout_imageViewParams.setMargins(0, (int) (deviceWidth * 0.12f), 0,(int) (deviceWidth * 0.02f)); 
		...
		imgView_NextParams.setMargins(0, (int) (deviceWidth * 0.07f), 0, 0); 
   ...
   //=======================================================================================================================
	...
	public void nextClick() {
		...
		System.out.println("post data >>> : "+quiz_userid+" : " + dateofBirth + " : " + gender	+ " : " + imageFilePath);

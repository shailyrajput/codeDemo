...
package com.illuminz.animation;
...
public class AnimationLayout extends ViewGroup {
	 ...
	 * resource.
	 */
	protected int mSidebarWidth = 900; 
	protected int mySidebarWidth = 500;
	...
	public void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (mOpened) {
			if (mPlaceLeft) {
				mContent.layout(l - mySidebarWidth, 0, r - mySidebarWidth, b);
	...
	protected void measureChild(View child, int parentWSpec, int parentHSpec) {
		...
		if (child == mSidebar) {
			...
			int width = (int) (getMeasuredWidth() * 1.0);
	...
	public void toggleSidebar() {
		...
		if (mOpened) {
			...
			if (mPlaceLeft) {
				mAnimation = new TranslateAnimation(0, mySidebarWidth, 0, 0);
	...
	public void openSidebar() {
		if (!mOpened) {
			toggleSidebar();
			System.out.println("side bar open");
		}
	}
	...
	public void closeSidebar() {
		if (mOpened) {
			toggleSidebar();
			System.out.println("side bar close");
		}
	}
